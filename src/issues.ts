...
z_open_times: { regex: /(one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)-(ten|fifteen|twenty|thirty|forty|fifty)/ig, ui: { label: "Time hyphenated", toLabel: "Unhyphenate", copy: "(one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)-", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
