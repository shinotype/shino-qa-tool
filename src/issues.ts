...
z_numbers_under_hundred: { regex: /(?<![cC]hapter|[pP]art|[sS]ection|[gG]rade|[lL]evel|[tT]ier|[cC]lass|[rR]ank)[^0-9\(\[\{][0-9]{1,2}[^0-9](?![LHMX]P|coins|gold|points|experience)/ig, ui: { label: "Numerals 1 through 99 (spell out?)", toLabel: "", copy: "(?<![cC]hapter|[pP]art|[sS]ection|[gG]rade|[lL]evel|[tT]ier|[cC]lass|[rR]ank)[^0-9\\(\\[\\{][0-9]{1,2}[^0-9](?![LHMX]P|coins|gold|points|experience)", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
