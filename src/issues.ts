...
const idlessIssues = {
  ...
  amongst: { regex: /amongst/gi, ui: { label: "amongst", toLabel: "among", copy: "", paste: "", mw: "among", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.YP]}, 
  ...
  forego: { regex: /forego/gi, ui: { label: "forego", toLabel: "forgo", copy: "", paste: "", mw: "forgo", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
  forewent: { regex: /forewent/gi, ui: { label: "forewent", toLabel: "forwent", copy: "", paste: "", mw: "forgo", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
  ...
  hurrah: { regex: /hurrah/gi, ui: { label: "hurrah", toLabel: "hooray", copy: "", paste: "", mw: "hooray", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
  ...
  light_headed: { regex: /light headed/gi, ui: { label: "light headed", toLabel: "light-headed", copy: "", paste: "", mw: "light-headed", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
  ...
  lightheaded: { regex: /lightheaded/gi, ui: { label: "lightheaded", toLabel: "light-headed", copy: "", paste: "", mw: "light-headed", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
  ...
  know_that: { regex: /know that/ig, ui: { label: "know that", toLabel: "(delete that?)", copy: "know that", paste: "", mw: "", copyLabels: false}, type: IssueType.RW, styleGuides: [StyleGuide.YP]}, 
  ...
  say_that: { regex: /say that/ig, ui: { label: "say that", toLabel: "(delete that?)", copy: "say that", paste: "", mw: "", copyLabels: false}, type: IssueType.RW, styleGuides: [StyleGuide.YP]}, 
  think_that: { regex: /think that/ig, ui: { label: "think that", toLabel: "(delete that?)", copy: "think that", paste: "", mw: "", copyLabels: false}, type: IssueType.RW, styleGuides: [StyleGuide.YP]}, 
  tomorrow: { regex: /tomorrow/ig, ui: { label: "tomorrow", toLabel: "the next day (in narration)", copy: "tomorrow", paste: "", mw: "", copyLabels: false}, type: IssueType.RW, styleGuides: [StyleGuide.YP]}, 
  yesterday: { regex: /yesterday/ig, ui: { label: "yesterday", toLabel: "the previous day (in narration)", copy: "yesterday", paste: "", mw: "", copyLabels: false}, type: IssueType.RW, styleGuides: [StyleGuide.YP]}, 
  ...
  backwards: { regex: /backwards/gi, ui: { label: "backwards", toLabel: "backward", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.YP]}, 
  ...
  forwards: { regex: /forwards/gi, ui: { label: "forwards", toLabel: "forward", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.YP]}, 
