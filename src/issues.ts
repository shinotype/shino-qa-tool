...
const idlessIssues = {
  space: { regex: /[ ]{2}/g, ui: { label: "Double spaces", copy: "  ", paste: " ", checkTypes: [Punctuation], }, },
  ...
  period2: { regex: /(^|[^\.])\.[?!$]/g, ui: { label: "Period preceding exclamation/question mark", copy: "[^\\.]\\.[?!$]", checkTypes: [Punctuation], }, },
  period3: { regex: /[?!]\./g, ui: { label: "Period following exclamation/question mark", copy: "[?!]\\.", checkTypes: [Punctuation], }, },
  apostrophe: { regex: /'/g, ui: { label: "Straight apostrophe", copy: "\\\'", checkTypes: [Punctuation], }, },
  apostrophe2: { regex: /‘s\b/ig, ui: { label: "‘s → ’s", copy: "‘s\\b", paste: "’s", checkTypes: [Punctuation], }, },
  ...
  causepos: { regex: /‘cause\b/ig, ui: { label: "‘cause → ’cause", copy: "‘cause\\b", paste: "’cause", checkTypes: [Punctuation], }, },
  suppos: { regex: /‘sup\b/ig, ui: { label: "‘sup → ’sup", copy: "‘sup\\b", paste: "’sup", checkTypes: [Punctuation], }, },
  empos: { regex: /‘em\b/ig, ui: { label: "‘em → ’em", copy: "‘em\\b", paste: "’em", checkTypes: [Punctuation], }, },
  boutpos: { regex: /‘bout\b/ig, ui: { label: "‘bout → ’bout", copy: "‘bout\\b", paste: "’bout", checkTypes: [Punctuation], }, },
  notherpos: { regex: /‘nother\b/ig, ui: { label: "‘nother → ’nother\\b", copy: "‘nother", paste: "’nother", checkTypes: [Punctuation], }, },
  forepos: { regex: /‘fore\b/ig, ui: { label: "‘fore → ’fore", copy: "‘fore\\b", paste: "’fore", checkTypes: [Punctuation], }, },
  fraidpos: { regex: /‘fraid\b/ig, ui: { label: "‘fraid → ’fraid", copy: "‘fraid\\b", paste: "’fraid", checkTypes: [Punctuation], }, },
  neathpos: { regex: /‘neath\b/ig, ui: { label: "‘neath → ’neath", copy: "‘neath\\b", paste: "’neath", checkTypes: [Punctuation], }, },
  gainstpos: { regex: /‘gainst\b/ig, ui: { label: "‘ganst → ’gainst", copy: "‘gainst\\b", paste: "’gainst", checkTypes: [Punctuation], }, },
  ceptpos: { regex: /‘cept\b/ig, ui: { label: "‘cept → ’cept", copy: "‘cept\\b", paste: "’cept", checkTypes: [Punctuation], }, },
  roundpos: { regex: /‘round\b/ig, ui: { label: "‘round → ’round", copy: "‘round\\b", paste: "’round", checkTypes: [Punctuation], }, },
  tilpos: { regex: /‘til\b/ig, ui: { label: "‘til → ’til", copy: "‘til\\b", paste: "’til", checkTypes: [Punctuation], }, },
  tispos: { regex: /‘tis\b/ig, ui: { label: "‘tis → ’tis", copy: "‘tis\\b", paste: "’tis", checkTypes: [Punctuation], }, },
  twaspos: { regex: /‘twas\b/ig, ui: { label: "‘twas → ’twas", copy: "‘twas\\b", paste: "’twas", checkTypes: [Punctuation], }, },
  tweenpos: { regex: /‘tween\b/ig, ui: { label: "‘tween → ’tween", copy: "‘tween\\b", paste: "’tween", checkTypes: [Punctuation], }, },
  twerepos: { regex: /‘twere\b/ig, ui: { label: "‘twere → ’twere", copy: "‘twere\\b", paste: "’twere", checkTypes: [Punctuation], }, },
  twixtpos: { regex: /‘twixt\b/ig, ui: { label: "‘twixt → ’twixt", copy: "‘twixt\\b", paste: "’twixt", checkTypes: [Punctuation], }, },
