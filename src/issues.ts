...
p_comma_eg: { regex: /e\.g\. /g, ui: { label: "e.g. (no comma)", toLabel: "e.g.,", copy: "e.g. ", paste: "e.g.,", mw: "e.g.", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
...
p_comma_ie: { regex: /i\.e\. /g, ui: { label: "i.e. (no comma)", toLabel: "i.e.,", copy: "i.e. ", paste: "i.e.,", mw: "i.e.", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
...
p_pos_each_others: { regex: /each others’/gi, ui: { label: "each others’", toLabel: "each other’s", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.PG, styleGuides: []}, 
...
p_pos_one_anothers: { regex: /one anothers’/gi, ui: { label: "one anothers’", toLabel: "one another’s", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.PG, styleGuides: []}, 
...
p_possessive_shared: { regex: /\w+ and [\w-]+’s/g, ui: { label: "Shared possessive?", toLabel: "", copy: "\\w+ and [\\w-]+’s", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
...
p_space5: { regex: /[a-zA-Z][\.?!]+ [’”]+/g, ui: { label: ".[space]”", toLabel: "", copy: "[a-zA-Z][\\.?!]+ [’”]+", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
p_space6: { regex: /[a-zA-Z](\.["'?!]*|[?!"']+)[A-Z]/g, ui: { label: "No space after end sentence punctuation", toLabel: "", copy: "[a-zA-Z](\\.[\"'?!]*|[?!\"']+)[A-Z]", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
...
z_big_numbers_comma: { regex: /\d{4,}/g, ui: { label: "Large numbers (in digits)", toLabel: "Add commas?", copy: "\\d{4,}", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_big_numbers_hyphen: { regex: /(one|two|three|four|five|six|seven|eight|nine|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety)-(hundred|thousand|million|billion)/gi, ui: { label: "Large number hyphenated", toLabel: "Unhyphenate?", copy: "(one|two|three|four|five|six|seven|eight|nine|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety)-(hundred|thousand|million|billion)", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
...
z_numbers_under_hundred: { regex: /(?<![cC]hapter|[pP]art|[sS]ection|[gG]rade|[lL]evel|[tT]ier|[cC]lass|[rR]ank)[^0-9\(\[\{][0-9]{1,2}[^0-9](?![LHMX]P|coins|gold|points|experience)/gi, ui: { label: "Numerals 1 through 99 (spell out?)", toLabel: "", copy: "(?<![cC]hapter|[pP]art|[sS]ection|[gG]rade|[lL]evel|[tT]ier|[cC]lass|[rR]ank)[^0-9\\(\\[\\{][0-9]{1,2}[^0-9](?![LHMX]P|coins|gold|points|experience)", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_open_times: { regex: /(one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)-(ten|fifteen|twenty|thirty|forty|fifty)/gi, ui: { label: "Time hyphenated", toLabel: "Unhyphenate", copy: "(one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)-", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
...
z_subjunctive: { regex: /as if \w+ was/gi, ui: { label: "as if __ was", toLabel: "as if __ were (?)", copy: "as if \\w+ was", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_symbol_ampersand: { regex: /\&/g, ui: { label: "& (symbol)", toLabel: "(spell out?)", copy: "&", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_symbol_dollar: { regex: /\$/g, ui: { label: "$ (symbol)", toLabel: "(spell out?)", copy: "$", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_symbol_greater_than: { regex: /\>/g, ui: { label: "> symbol", toLabel: "(avoid using?)", copy: "\\>", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: [StyleGuide.JNC]}, 
z_symbol_hex: { regex: /\#/g, ui: { label: "# (symbol)", toLabel: "(spell out?)", copy: "#", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_symbol_less_than: { regex: /\</g, ui: { label: "< symbol", toLabel: "(avoid using?)", copy: "\\<", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: [StyleGuide.JNC]}, 
z_symbol_macron: { regex: /(ā|ē|ī|ō|ū)/gi, ui: { label: "ā, ē, ī, ō, or ū", toLabel: "(avoid?)", copy: "(ā|ē|ī|ō|ū)", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: [StyleGuide.JNC]}, 
z_symbol_percent: { regex: /\%/g, ui: { label: "% (symbol)", toLabel: "(spell out?)", copy: "%", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
z_symbol_tilde: { regex: /\~/g, ui: { label: "~ (symbol)", toLabel: "(elongate vowels?)", copy: "~", paste: "", mw: "", copyLabels: false}, type: IssueType.PG, styleGuides: []}, 
_size: { regex: /-size\b/gi, ui: { label: "-size", toLabel: "-sized (?) (house spelling)", copy: "-size\\b", paste: "-sized", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
adzuki: { regex: /adzuki/gi, ui: { label: "adzuki", toLabel: "azuki (house spelling)", copy: "adzuki", paste: "azuki", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
aka1: { regex: /\bAKA\b/g, ui: { label: "AKA", toLabel: "aka", copy: "", paste: "", mw: "aka", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
aka2: { regex: /a\.k\.a\./gi, ui: { label: "a.k.a.", toLabel: "aka", copy: "", paste: "", mw: "aka", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
animes: { regex: /animes/gi, ui: { label: "animes", toLabel: "anime (pl.)", copy: "animes", paste: "anime", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
backline1: { regex: /backline/gi, ui: { label: "backline (adjective)", toLabel: "", copy: "backline", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
backline2: { regex: /back line/gi, ui: { label: "back line (noun)", toLabel: "", copy: "back line", paste: "", mw: "back line", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
backlines: { regex: /backlines/gi, ui: { label: "backlines", toLabel: "back lines", copy: "", paste: "", mw: "back line", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
bare_handed: { regex: /bare-handed/gi, ui: { label: "bare-handed (adj. or adv.)", toLabel: "", copy: "bare-handed", paste: "", mw: "bare-handed", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
battle_ax: { regex: /battle-ax\b/gi, ui: { label: "battle-ax", toLabel: "battle-axe (house spelling)", copy: "battle-ax\\b", paste: "battle-axe", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
benefitted: { regex: /benefitted/gi, ui: { label: "benefitted", toLabel: "benefited", copy: "", paste: "", mw: "benefit", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
benefitting: { regex: /benefitting/gi, ui: { label: "benefitting", toLabel: "benefiting", copy: "", paste: "", mw: "benefit", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
bite_size: { regex: /bite-size\b/gi, ui: { label: "bite-size", toLabel: "bite-sized (house spelling)", copy: "bite-size\\b", paste: "bite-sized", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
bite_sized: { regex: /bite-sized/gi, ui: { label: "bite-sized", toLabel: "bite-size", copy: "", paste: "", mw: "bite-size", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.YP]}, 
...
boys_school1: { regex: /boys school/gi, ui: { label: "boys school", toLabel: "boys’ school", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
boys_school2: { regex: /boy’s school/gi, ui: { label: "boy’s school", toLabel: "boys’ school", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
camembert: { regex: /camembert/g, ui: { label: "camembert", toLabel: "Camembert", copy: "", paste: "", mw: "camembert", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
close_quarter_combat: { regex: /close-quarter combat/gi, ui: { label: "close-quarter combat", toLabel: "close-quarters combat", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
close_quarters_combat: { regex: /close quarters combat/gi, ui: { label: "close quarters combat", toLabel: "close-quarters combat", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
cos: { regex: /’cos\b/gi, ui: { label: "’cos", toLabel: "’cause or ’cuz (house spelling)", copy: "’cos", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
could_of: { regex: /could of/gi, ui: { label: "could of", toLabel: "could have", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
coz: { regex: /’coz\b/gi, ui: { label: "’coz", toLabel: "’cause or ’cuz (house spelling)", copy: "’coz", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
dare_say: { regex: /dare say/gi, ui: { label: "dare say", toLabel: "daresay (?)", copy: "dare say", paste: "daresay", mw: "daresay", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
dialog: { regex: /dialog\b/, ui: { label: "dialog", toLabel: "dialogue (?)", copy: "dialog", paste: "dialogue", mw: "dialogue", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
dialogue_box: { regex: /dialogue box/gi, ui: { label: "dialogue box", toLabel: "dialog box", copy: "", paste: "", mw: "dialog box", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
dungeon_dive: { regex: /dungeon-dive/gi, ui: { label: "dungeon-dive", toLabel: "dungeon dive (n., v.)", copy: "dungeon-dive", paste: "dungeon dive", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
e_book: { regex: /\be-book\b/gi, ui: { label: "e-book", toLabel: "ebook (house style)", copy: "\\be-book\\b", paste: "\\bebook\\b", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
e_mail: { regex: /\be-mail\b/gi, ui: { label: "e-mail", toLabel: "email", copy: "", paste: "", mw: "email", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
fanbase: { regex: /fanbase/gi, ui: { label: "fanbase", toLabel: "fan base", copy: "", paste: "", mw: "fan base", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
fanservice: { regex: /fanservice/gi, ui: { label: "fanservice", toLabel: "fan service", copy: "", paste: "", mw: "fan service", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
first_name_basis: { regex: /first name basis/gi, ui: { label: "first name basis", toLabel: "first-name basis", copy: "", paste: "", mw: "first-name basis", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
girls_school1: { regex: /girls school/gi, ui: { label: "girls school", toLabel: "girls’ school", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
girls_school2: { regex: /girl’s school/gi, ui: { label: "girl’s school", toLabel: "girls’ school", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
greatax: { regex: /greatax\b/gi, ui: { label: "greatax", toLabel: "greataxe (house spelling)", copy: "greatax\\b", paste: "greataxe", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
heads_up1: { regex: /heads up/gi, ui: { label: "heads up (interjection?)", toLabel: "", copy: "heads up", paste: "", mw: "heads up", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
heads_up2: { regex: /heads-up/gi, ui: { label: "heads-up (noun or adj.)", toLabel: "", copy: "heads-up", paste: "", mw: "heads-up", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
high_rise: { regex: /high rise/gi, ui: { label: "high rise", toLabel: "high-rise", copy: "", paste: "", mw: "high-rise", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
hivemind: { regex: /hivemind/gi, ui: { label: "hivemind", toLabel: "hive mind", copy: "", paste: "", mw: "hive mind", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
husband_to_be: { regex: /husband to be/gi, ui: { label: "husband to be", toLabel: "husband-to-be", copy: "", paste: "", mw: "husband-to-be", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
ided: { regex: /\bided\b/gi, ui: { label: "IDed", toLabel: "ID’d", copy: "\\bIDed\\b", paste: "ID’d", mw: "ID", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
iding: { regex: /\biding\b/gi, ui: { label: "IDing", toLabel: "ID’ing", copy: "\\bIDing\\b", paste: "ID’ing", mw: "ID", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
ids: { regex: /\bids\b/gi, ui: { label: "IDs", toLabel: "ID’s", copy: "\\bIDs\\b", paste: "ID’s", mw: "ID", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
jack_of_all_trades: { regex: /jack of all trades/gi, ui: { label: "jack of all trades", toLabel: "jack-of-all-trades", copy: "", paste: "", mw: "jack-of-all-trades", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
jousei: { regex: /jousei/gi, ui: { label: "jousei", toLabel: "josei (house style)", copy: "jousei", paste: "josei", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
kimonos: { regex: /kimonos/gi, ui: { label: "kimonos", toLabel: "kimono (pl.; house spelling)", copy: "kimonos", paste: "kimono", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
kouhai: { regex: /kouhai/gi, ui: { label: "kouhai", toLabel: "kohai (house style)", copy: "kouhai", paste: "kohai", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
lead: { regex: /(?<!the|a|could|couldn’t|would|wouldn’t|should|shouldn’t|can|can’t|will|won’t|shall|shan’t|’ll|might|may|did|didn’t|to)[+ lead](\blead\b)/gi, ui: { label: "lead (should be led, past tense?)", toLabel: "", copy: "(?<!the|a|could|couldn't|would|wouldn't|should|shouldn't|can|can't|will|won't|shall|’ll|might|may|did|didn't|to)[+ lead](\\blead\\b)", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
learnt: { regex: /\blearnt\b/gi, ui: { label: "learnt", toLabel: "learned", copy: "", paste: "", mw: "learn", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
live_stream: { regex: /live-stream/gi, ui: { label: "live-stream", toLabel: "live stream", copy: "", paste: "", mw: "live stream", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.YP]}, 
live_stream2: { regex: /live-stream/gi, ui: { label: "live-stream", toLabel: "livestream (house spelling)", copy: "live-stream", paste: "livestream", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
live_stream3: { regex: /live stream/gi, ui: { label: "live stream", toLabel: "livestream (house spelling)", copy: "live stream", paste: "livestream", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
livestream: { regex: /livestream/gi, ui: { label: "livestream", toLabel: "live stream", copy: "", paste: "", mw: "live stream", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.YP]}, 
...
m_hm: { regex: /\bm-hm\b/gi, ui: { label: "m-hm", toLabel: "mm-hmm", copy: "\\bm-hm\\b", paste: "mm-hmm", mw: "mm-hmm", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
mangas: { regex: /mangas/gi, ui: { label: "mangas", toLabel: "manga (pl.)", copy: "mangas", paste: "manga", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
mhm: { regex: /\bmhm\b/ig, ui: { label: "mhm", toLabel: "mm-hmm", copy: "\\bmhm\\b", paste: "mm-hmm", mw: "mm-hmm", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
mid_size: { regex: /mid-size/gi, ui: { label: "mid-size", toLabel: "midsize", copy: "", paste: "", mw: "midsize", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.YP]}, 
midforties: { regex: /midforties/gi, ui: { label: "midforties", toLabel: "mid-forties", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
midsentence: { regex: /midsentence/gi, ui: { label: "midsentence", toLabel: "mid-sentence", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
midsize: { regex: /midsize\b/gi, ui: { label: "midsize", toLabel: "midsized (house spelling)", copy: "midsize\\b", paste: "midsized", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
midthirties: { regex: /midthirties/gi, ui: { label: "midthirties", toLabel: "mid-thirties", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
midtwenties: { regex: /midtwenties/gi, ui: { label: "midtwenties", toLabel: "mid-twenties", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
mm_hm: { regex: /\bmm-hm\b/gi, ui: { label: "mm-hm", toLabel: "mm-hmm", copy: "\\bmm-hm\\b", paste: "mm-hmm", mw: "mm-hmm", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
mont_blanc: { regex: /mont blanc/g, ui: { label: "mont blanc", toLabel: "Mont Blanc", copy: "", paste: "", mw: "Mont Blanc", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
one_night_stand: { regex: /one night stand/gi, ui: { label: "one night stand", toLabel: "one-night stand", copy: "", paste: "", mw: "one-night stand", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
outa: { regex: /\bouta\b/gi, ui: { label: "outa", toLabel: "outta (house style)", copy: "\\bouta\\b", paste: "outta", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC,StyleGuide.YP]}, 
...
oversize: { regex: /oversize\b/gi, ui: { label: "oversize", toLabel: "oversized (house spelling)", copy: "oversize\\b", paste: "oversized", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
p_quotes_single: { regex: /[?!](?:’”)/g, ui: { label: "? and ! inside single quotes", toLabel: "(check if they should go outside)", copy: "[?!](?:’”)", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
pickax: { regex: /pickax\b/gi, ui: { label: "pickax", toLabel: "pickaxe (house spelling)", copy: "pickax\\b", paste: "pickaxe", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
poleax: { regex: /poleax\b/gi, ui: { label: "poleax", toLabel: "poleaxe (house spelling)", copy: "poleax\\b", paste: "poleaxe", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
q_and_a: { regex: /Q \& A/g, ui: { label: "Q & A", toLabel: "Q&A (house spelling)", copy: "Q & A", paste: "Q&A", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
q_and_a2: { regex: /Q and A/g, ui: { label: "Q and A", toLabel: "Q&A (house spelling)", copy: "Q and A", paste: "Q&A", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
r_and_d: { regex: /R \& D/g, ui: { label: "R & D", toLabel: "R&D (house spelling)", copy: "R & D", paste: "R&D", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
rack: { regex: /\brack/gi, ui: { label: "rack (to cause to suffer?)", toLabel: "", copy: "rack", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
recreate: { regex: /recreate/gi, ui: { label: "recreate", toLabel: "re-create (to create anew?)", copy: "recreate", paste: "re-create", mw: "re-create", copyLabels: false}, type: IssueType.SW, styleGuides: []}, 
...
rock_paper_scissors: { regex: /rock paper scissors/gi, ui: { label: "rock paper scissors", toLabel: "rock-paper-scissors (house spelling)", copy: "rock paper scissors", paste: "rock-paper-scissors", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
saintess: { regex: /saintess/gi, ui: { label: "saintess", toLabel: "saint (all genders)", copy: "saintess", paste: "saint", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
sempai: { regex: /sempai/gi, ui: { label: "sempai", toLabel: "senpai (house spelling)", copy: "sempai", paste: "senpai", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
senpais: { regex: /senpais/gi, ui: { label: "senpais", toLabel: "senpai (pl.)", copy: "senpais", paste: "senpai", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
shoujo: { regex: /shoujo/gi, ui: { label: "shoujo", toLabel: "shojo", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
shounen: { regex: /shounen/gi, ui: { label: "shounen", toLabel: "shonen", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
shousetsuka: { regex: /Shousetsuka ni Narou/gi, ui: { label: "Shousetsuka ni Narou", toLabel: "Shosetsuka ni Naro (house spelling)", copy: "Shousetsuka ni Narou", paste: "Shosetsuka ni Naro", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
side_note: { regex: /side note/gi, ui: { label: "side note", toLabel: "sidenote", copy: "", paste: "", mw: "sidenote", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
signalled: { regex: /signalled/gi, ui: { label: "signalled", toLabel: "signaled", copy: "", paste: "", mw: "signaled", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
signalling: { regex: /signalling/gi, ui: { label: "signalling", toLabel: "signaling", copy: "", paste: "", mw: "signaling", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
spell_book: { regex: /spell book/gi, ui: { label: "spell book", toLabel: "spellbook (house spelling)", copy: "spell book", paste: "spellbook", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
staffs: { regex: /staffs/gi, ui: { label: "staffs (the weapon?)", toLabel: "staves (pl.; house spelling)", copy: "staffs", paste: "staves", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
straight_up: { regex: /straight-up/gi, ui: { label: "straight-up", toLabel: "straight up (?)", copy: "straight-up", paste: "straight up", mw: "straight up", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
student_council: { regex: /Student Council/g, ui: { label: "Student Council", toLabel: "student council (lowercase)", copy: "Student Council", paste: "student council", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
targetted: { regex: /targetted/gi, ui: { label: "targetted", toLabel: "targeted", copy: "", paste: "", mw: "target", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
targetting: { regex: /targetting/gi, ui: { label: "targetting", toLabel: "targeting", copy: "", paste: "", mw: "target", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
test_fire: { regex: /test fire/gi, ui: { label: "test fire", toLabel: "test-fire (verb?)", copy: "test fire", paste: "test-fire", mw: "test-fire", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
the_up_and_up: { regex: /the up and up/gi, ui: { label: "the up and up", toLabel: "the up-and-up", copy: "", paste: "", mw: "up-and-up", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
through_the_ringer: { regex: /through the ringer/gi, ui: { label: "through the ringer", toLabel: "through the wringer", copy: "", paste: "", mw: "through the wringer", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
...
toe_to_toe1: { regex: /toe-to-toe/gi, ui: { label: "toe-to-toe (slugging it out?)", toLabel: "", copy: "toe-to-toe", paste: "", mw: "toe-to-toe", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
toe_to_toe2: { regex: /toe to toe/gi, ui: { label: "toe to toe (facing one another?)", toLabel: "", copy: "toe to toe", paste: "", mw: "toe to toe", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
uber: { regex: /über/gi, ui: { label: "über", toLabel: "uber (house spelling)", copy: "über", paste: "uber", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
vice_: { regex: /\bvice-/gi, ui: { label: "vice- (hyphenated)", toLabel: "vice (open?)", copy: "\\bvice-", paste: "vice", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
vs: { regex: /\bvs\b/gi, ui: { label: "vs", toLabel: "versus", copy: "\\bvs\\b", paste: "versus", mw: "versus", copyLabels: true}, type: IssueType.SP, styleGuides: []}, 
vtuber: { regex: /vtuber/g, ui: { label: "vtuber", toLabel: "VTuber", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
wrack: { regex: /\bwrack/gi, ui: { label: "wrack (to ruin?)", toLabel: "", copy: "wrack", paste: "", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
wrack_brain: { regex: /wrack \w+ brain/gi, ui: { label: "wrack one's brain", toLabel: "rack one's brain", copy: "wrack \\w+ brain", paste: "", mw: "rack one's brain", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
wracked_brain: { regex: /wracked \w+ brain/gi, ui: { label: "wracked one's brain", toLabel: "racked one's brain", copy: "wracked \\w+ brain", paste: "", mw: "rack one's brain", copyLabels: false}, type: IssueType.SP, styleGuides: []}, 
...
yookai: { regex: /yōkai/gi, ui: { label: "yōkai", toLabel: "yokai", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
youkai: { regex: /youkai/gi, ui: { label: "youkai", toLabel: "yokai", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
yukatas: { regex: /yukatas/gi, ui: { label: "yukatas", toLabel: "yukata (pl.; house spelling)", copy: "yukatas", paste: "yukata", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
...
long_string: { regex: /\S{25,}/gi, ui: { label: "String > 25 characters", toLabel: "", copy: "\\S{25,}", paste: "", mw: "", copyLabels: false}, type: IssueType.RW, styleGuides: []}, 
...
backward: { regex: /\bbackward\b/gi, ui: { label: "backward", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
backwards: { regex: /\bbackwards\b/gi, ui: { label: "backwards", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
...
downward: { regex: /\bdownward\b/gi, ui: { label: "downward", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
downwards: { regex: /\bdownwards\b/gi, ui: { label: "downwards", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
downwards2: { regex: /\bdownwards\b/gi, ui: { label: "downwards", toLabel: "downward", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.YP]}, 
...
forward: { regex: /\bforward\b/gi, ui: { label: "forward", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
forwards: { regex: /\bforwards\b/gi, ui: { label: "forwards", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
...
inward: { regex: /\binward\b/gi, ui: { label: "inward", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
inwards: { regex: /\binwards\b/gi, ui: { label: "inwards", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
inwards2: { regex: /\binwards\b/gi, ui: { label: "inwards", toLabel: "inward", copy: "", paste: "inward", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.YP]}, 
...
leaped: { regex: /leaped/gi, ui: { label: "leaped", toLabel: "", copy: "leaped", paste: "", mw: "leap", copyLabels: false}, type: IssueType.SW, styleGuides: []}, 
leapt: { regex: /leapt/gi, ui: { label: "leapt", toLabel: "", copy: "leapt", paste: "", mw: "leap", copyLabels: false}, type: IssueType.SW, styleGuides: []}, 
outward: { regex: /\boutward\b/gi, ui: { label: "outward", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
outwards: { regex: /\boutwards\b/gi, ui: { label: "outwards", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
outwards2: { regex: /\boutwards\b/gi, ui: { label: "outwards", toLabel: "outward", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.YP]}, 
...
upward: { regex: /\bupward\b/gi, ui: { label: "upward", toLabel: "", copy: "\\bupward\\b", paste: "", mw: "", copyLabels: false}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
upwards: { regex: /upwards/gi, ui: { label: "upwards", toLabel: "", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.JNC]}, 
upwards2: { regex: /\bupwards\b/gi, ui: { label: "upwards", toLabel: "upward", copy: "", paste: "", mw: "", copyLabels: true}, type: IssueType.SW, styleGuides: [StyleGuide.YP]}, 
