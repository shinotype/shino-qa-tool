...
outa: { regex: /\bouta\b/gi, ui: { label: "outa", toLabel: "outta (house style)", copy: "\\bouta\\b", paste: "outta", mw: "", copyLabels: false}, type: IssueType.SP, styleGuides: [StyleGuide.JNC]}, 
